...
public enum ValidateType implements ValidateInterface {
    ...
    CHINA_PHONE(Constant.RegularAbout.CHINA_PHONE, "国内电话号码"),//国内电话号码(0511-4405222、021-87888822)
    ID_CARD(Constant.RegularAbout.ID_CARD, " 身份证号"),//身份证号(15位、18位数字)
    SHORT_ID_CARD(Constant.RegularAbout.SHORT_ID_CARD, "短身份证号码"),//短身份证号码(数字、字母x结尾)
    ACCOUNT(Constant.RegularAbout.ACCOUNT, "帐号"),//帐号是否合法(字母开头，允许5-16字节，允许字母数字下划线)
    PASSWORD(Constant.RegularAbout.PASSWORD, "密码"),//密码(以字母开头，长度在6~18之间，只能包含字母、数字和下划线)
    STRONG_PASSWORD(Constant.RegularAbout.STRONG_PASSWORD, "强密码"),//强密码(必须包含大小写字母和数字的组合，不能使用特殊字符，长度在8-10之间)
    DATE_YYYY_MM_DD(Constant.RegularAbout.DATE_YYYY_MM_DD, "日期（yyyy-mm-dd）"),//日期格式
    MONTH(Constant.RegularAbout.MONTH, "月份"),//一年的12个月
    DAY(Constant.RegularAbout.DAY, "日期天"),//一个月的31天
    MONEY(Constant.RegularAbout.MONEY, "钱"),//钱
    XML_FILE_NAME(Constant.RegularAbout.XML_FILE_NAME, "xml文件名"),//XML文件名
    CHINESE_LANGUAGE(Constant.RegularAbout.CHINESE_LANGUAGE, "中文"),//中文
    TWO_CHAR(Constant.RegularAbout.TWO_CHAR, "双字节字符"),//双字节字符
    QQ(Constant.RegularAbout.QQ, "QQ号"),//腾讯QQ号
    MAIL_NO(Constant.RegularAbout.MAIL_NO, "中国邮政编码"),//中国邮政编码
    IP(Constant.RegularAbout.IP, "IP地址"),//IP地址
    NUMBER(Constant.RegularAbout.NUMBER, "数字"),//NUMBER
    FLOAT(Constant.RegularAbout.FLOAT, "浮点数"),//浮点数
    ENGLISH_NUMBER(Constant.RegularAbout.ENGLISH_NUMBER, "英文数字");//英文和数字
