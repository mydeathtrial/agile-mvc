...
public class DictionaryMainService extends BusinessService<DictionaryMainEntity> {
    ...
    @Mapping(value = "/dictionary-main", method = RequestMethod.POST)
    ...
    @Mapping(path = "/dictionary-main/{id}", method = RequestMethod.DELETE)
    ...
    @Models({DictionaryMainEntity.class})
    @Mapping(path = "/dictionary-main/{id}", method = RequestMethod.GET)
